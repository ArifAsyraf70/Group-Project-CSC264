...
<body data-spy="scroll" data-target=".navbar" data-offset="40" id="home" >
    ...
    <header class="header">
        <div class="overlay">
            ...
            <h1 class="subtitle">WELCOME TO THE RAZER FUTSAL </h1>
            <h1 class="title">PROVE YOUR SKILL HERE !!</h1> 
            <?php echo "<a class='btn btn-primary mt-3' href='bookingPage.php?snumber=".$userid."'>Book A Court </a>"  ?>
        </div>      
    </header>
    <!-- End Of Page Header --> 
    <!-- About Section -->
        ...
        <div class="container">
            <div class="row align-items-center">                
                <div class="col-md-6">
                    ...
                    <p class="mb-1 font-weight-bold">Monday - Friday : <span class="font-weight-normal pl-2 text-muted">8:00 am - 5:00 am</span></p>
                   
                    <p class="mb-1 font-weight-bold">Saturday - Sunday : <span class="font-weight-normal pl-2 text-muted">9:00 am - 12:00 am</span></p>
            ...
            <div class="row align-items-center">
                <div class="col-md-6">
                    <h6 class="section-subtitle">The History</h6>
                    <h3 class="section-title">FUTSAL COURT PERFORMANCE</h3>
                    <p><justify>Futsal is a small-sided game played with a smaller (size 3 or 4) low bounce ball, on a basketball sized court without rebound walls or nets. It is a game which combines fun, creativity, speed, technique, teamwork and quick thinking. With millions of players worldwide, futsal is a fantastic game in its own right, with professional leagues throughout Europe, South America and Asia and a FIFA Futsal World Cup every four years.</justify></p>
                </div>
    ...
    <section id="service" class="pattern-style-4 has-overlay">
        <div class="container raise-2">
            <h6 class="section-subtitle text-center">Top popular court</h6>
            <h3 class="section-title mb-6 pb-3 text-center">Recent court</h3>
            <div class="row">
                    ...
                    <a href="javascrip:void(0)" class="custom-list">
                        ...
                        <div class="info">
                            <div class="head clearfix">
                                <h5 class="title float-left">GRASSY COURT</h5>
                                <p class="float-right text-primary">RM60 (PER HOUR)</p>
                            </div>
                            <div class="body">
                                <p>Synthetic turf is the best surface for futsal fields, as it guarantees shock absorption, reducing abrasion from falls to a minimum; natural feeling, great aesthetic effect and optimal slide. All of that with minimum maintenance and availability all year round, with any climate condition.</p>
                            </div>
                        </div>
                    </a>
                </div>
                ...
                <div class="col-md-6 mb-4">
                    <a href="javascrip:void(0)" class="custom-list">
                        ...
                        <div class="info">
                            <div class="head clearfix">
                                <h5 class="title float-left">GOLDY COURT</h5>
                                <p class="float-right text-primary">RM65 (PER HOUR)</p>
                            </div>
                            <div class="body">
                                <p>Goldy court is one of the most best court as it provide an old -school design futsal court. If the player like a nostalgic vibe, then this is the best choice as not only it gives an aesthetic vibe but also a functional court. As the name stated, goldy means gold as the time is gold and precious. </p>
                            </div>
                        </div>
                    </a>
                </div>
                        ...
                        <div class="card-body">
                            <div class="media align-items-center mb-3">
                                ...
                                <div class="media-body">
                                    <h6 class="mt-1 mb-0">AHMAD ALBAB</h6>
                                    <small class="text-muted mb-0">Futsal athletes</small>     
                                </div>
                            </div>
                            <p class="mb-0">    The futsal is great, I really enjoy playing with my friend at Goldy court. Would repeat my booking on this razer futsal. WOOHOOO!!</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 my-3 my-md-0">
                    <div class="card">
                        <div class="card-body">
                            <div class="media align-items-center mb-3">
                                ...
                                <div class="media-body">
                                    <h6 class="mt-1 mb-0">NEYMAR SINIOR</h6>
                                    <small class="text-muted mb-0">Freestyle futsal player</small>      
                                </div>
                            </div>
                            <p class="mb-0">Overall, REALLY GOOD. SUGOI!!</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 my-3 my-md-0">
                    <div class="card">
                        <div class="card-body">
                            <div class="media align-items-center mb-3">
                                ...
                                <div class="media-body">
                                    <h6 class="mt-1 mb-0">ABUELA MIGUEL</h6>
                                    <small class="text-muted mb-0">Random person</small>        
                                </div>
                            </div>
                            <p class="mb-0">Me and my friends very enjoy the game and the service is very nice. </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 my-3 my-md-0">
                    <div class="card">
                        <div class="card-body">
                            <div class="media align-items-center mb-3">
                                <img class="mr-4" src="assets/imgs/avatar-3.jpg" alt="Download free bootstrap 4 landing page, free boootstrap 4 templates, Download free bootstrap 4.1 landing page, free boootstrap 4.1.1 templates, Pigga Landing page">
                                <div class="media-body">
                                    <h6 class="mt-1 mb-0">SANTESH KUMAR</h6>
                                    <small class="text-muted mb-0">Nigerian Prince</small>        
                                </div>
                            </div>
                            <p class="mb-0">मैं इस रेटिंग से बहुत संतुष्ट हूं, मुझसे आखिरी शब्द ... सैमसंग आह </p>
                        </div>
                    </div>
                </div>
            </div>
